...
type CacheInvalidation struct {
	Name             string                `json:"name,omitempty" yaml:"name,omitempty"`
	Status           string                `json:"status,omitempty" yaml:"status,omitempty"`
	Kind             CacheInvalidationKind `json:"kind,omitempty" yaml:"kind,omitempty"`
	InvalidationType CacheInvalidationType `json:"invalidation_type,omitempty" yaml:"invalidation_type,omitempty"`
